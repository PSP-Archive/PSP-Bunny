...
NPVertex __attribute__((aligned(16))) bunny_vertices[16301*3];
...
int main(int argc, char* argv[])
{
	...
	while(running())
	{
		...
		*/
		...
		sceGumDrawArray(GU_TRIANGLES,NP_VERTEX_FORMAT|GU_TRANSFORM_3D,16301*3,0,bunny_vertices);
